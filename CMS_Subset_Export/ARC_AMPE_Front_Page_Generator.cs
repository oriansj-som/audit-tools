...
namespace ARC_AMPE_Front_Page_Generator
{
    class ARC_AMPE_Front_Page_Generator
    {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            ws.Cells[row, 4].Formula = "=IF('" + page + "'!B$12=\"\",\"\",'" + page + "'!B$12)";
            ws.Cells[row, 5].Formula = "=IF('" + page + "'!B$20=\"\",\"\",'" + page + "'!B$20)";
            ws.Cells[row, 6].Formula = "=IF('" + page + "'!B$21=\"\",\"\",'" + page + "'!B$21)";
            ws.Cells[row, 6].Style.Numberformat.Format = "MM/DD/YYYY";
            ws.Cells[row, 7].Formula = "=IF('" + page + "'!B$22=\"\",\"\",'" + page + "'!B$22)";
            ws.Cells[row, 7].Style.Numberformat.Format = "MM/DD/YYYY";
            ws.Cells[row, 8].Formula = "=IF('" + page + "'!B$26=\"\",\"\",'" + page + "'!B$26)";
            ws.Cells[row, 9].Formula = "=IF('" + page + "'!B$30=\"\",\"\",'" + page + "'!B$30)";
            ws.Cells[row, 10].Formula = "=IF('" + page + "'!B$31=\"\",\"\",'" + page + "'!B$31)";
        }
